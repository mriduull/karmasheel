...
from .views import (
    JobWorkerRecommendationsView,
    OpportunityAdvisoryView,
    WorkerJobRecommendationsView,
)
...
urlpatterns = [
    ...
    path("opportunities/", OpportunityAdvisoryView.as_view(), name="opportunity_advisory"),
]
