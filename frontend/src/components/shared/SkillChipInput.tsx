import { forwardRef, useId, useImperativeHandle, useState, type KeyboardEvent } from 'react'
...
export interface SkillChipInputHandle {
 ...
 */
export const SkillChipInput = forwardRef<SkillChipInputHandle, SkillChipInputProps>(
  function SkillChipInput({ label, hint, value, onChange }, ref) {
    ...
    useImperativeHandle(ref, () => ({
      commitDraft: commitDraftIfPresent,
    }))
